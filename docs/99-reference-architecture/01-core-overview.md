...
| 26-opt-tui-architecture.md | Terminal User Interface — real-time monitoring, Textual + Textual Web |
...
| 26-opt-tui-architecture.md | Interactive terminal interface (Textual) |
| 27-opt-multi-channel-gateway.md | Multi-channel delivery (Telegram, Slack, Discord, WebSocket) with cross-channel sessions |
...
If adopting 27-opt-multi-channel-gateway.md, ensure 04-core-backend-architecture.md and 24-opt-telegram-bot-integration.md are in place.

...
The layout directly implements the patterns from multiple other standards: the layered backend architecture (04) maps to `api/`, `services/`, `repositories/`, `models/`; module structure (05) maps to the `modules/` directory; testing standards (12) map to the hybrid `tests/unit/`, `tests/integration/`, `tests/e2e/` layout; and configuration standards (07) map to `config/` with `.env` and YAML files.
...
├── pytest.ini
│
├── var/                            # Runtime artifacts (not tracked)
...
│           ├── 03-core-primitive-identification.md
│           ├── 04-core-backend-architecture.md
│           ├── 05-core-module-structure.md
│           ├── 20-opt-data-layer.md
│           ├── 21-opt-event-architecture.md
│           ├── 22-opt-frontend-architecture.md
│           ├── 06-core-authentication.md
│           ├── 07-core-python-coding-standards.md
│           ├── 23-opt-typescript-coding-standards.md
│           ├── 08-core-observability.md
│           ├── 09-core-development-workflow.md
│           ├── 10-core-error-codes.md
│           ├── 11-core-project-template.md
│           ├── 12-core-testing-standards.md
│           ├── 13-core-security-standards.md
│           ├── 14-core-data-protection.md
│           ├── 15-core-background-tasks.md
│           ├── 24-opt-telegram-bot-integration.md
│           ├── 17-core-deployment-bare-metal.md
│           ├── 18-core-deployment-azure.md
│           └── 25-opt-telegram-client-integration.md
│
├── modules/
│   ├── backend/
│   │   ├── __init__.py
...
See **12-core-testing-standards.md** for complete testing guidance.

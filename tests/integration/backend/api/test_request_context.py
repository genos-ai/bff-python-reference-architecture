...
NOTE: These tests require BaseHTTPMiddleware (RequestContextMiddleware)
which is excluded from the test app to avoid async DB session conflicts.
"""
...
pytestmark = pytest.mark.skip(
    reason="Test app excludes BaseHTTPMiddleware to avoid async DB session conflicts"
)
